...
namespace SmartPlant.Data.Migrations
{
    ...
    [Migration("20260101120139_AddEmailVerificationOtp")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartPlant.Models.Entities.UserPreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SmartPlant.Models.Entities.UserPreference", b =>
                {
                    b.HasOne("SmartPlant.Models.Entities.User", "User")
                        .WithOne("Preference")
                        .HasForeignKey("SmartPlant.Models.Entities.UserPreference", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
